...
namespace FashionHub.Services
{
    public class ImageFeatureService
    {
        ...
        public ImageFeatureService(string modelPath)
        {
            ...
            // Tạo model
            var emptyData = _mlContext.Data.LoadFromEnumerable(new List<ModelInputData>());
        ...
        public float[] GetFeatureVector(string imagePath)
        {
            ...
            var dataView = _mlContext.Data.LoadFromEnumerable(new List<ModelInputData> { data });
        ...
        private class ModelInputData
        {
            ...
            public float[] data { get; set; } // Tên biến phải trùng với ModelInput ("data")
        }
    }
}